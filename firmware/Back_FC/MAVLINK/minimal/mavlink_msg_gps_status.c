...
{
	return 0;// _MAV_RETURN_uint8_t_array(msg, satellite_prn, 20,  1);
}
...
{
	return 0;//_MAV_RETURN_uint8_t_array(msg, satellite_used, 20,  21);
}
...
{
	return 0;//_MAV_RETURN_uint8_t_array(msg, satellite_elevation, 20,  41);
}
...
{
	return 0;//_MAV_RETURN_uint8_t_array(msg, satellite_azimuth, 20,  61);
}
...
{
	return 0;//_MAV_RETURN_uint8_t_array(msg, satellite_snr, 20,  81);
}
